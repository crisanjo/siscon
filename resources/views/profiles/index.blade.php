  ...
  <div class="row">
    <div class="col-lg-12 margin-tb">
        <div class="pull-right">
            <a class="btn btn-success float-right btn-sm" href="{{ route('profiles.create') }}" name="Novo"> Novo</a>
        </div>
    </div>
  </div>
  <hr>
          ...
          <tbody>
            @foreach ($profiles as $profile)
              <tr>
                ...
                <td>
                  <a class="btn btn-warning btn-sm mr-1" href="{{ route('profiles.edit',$profile->id) }}" name="Editar">Editar</a>
