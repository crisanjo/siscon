  ...
  <div class="row">
    <div class="col-lg-12 margin-tb">
        <div class="pull-right">
            <a class="btn btn-success float-right btn-sm" href="{{ route('services.create') }}" name="Novo"> Novo</a>
        </div>
    </div>
  </div>
  <hr>
          ...
          <tbody>
            @foreach ($services as $service)
              <tr>
                ...
                <td>
                  <a class="btn btn-warning btn-sm mr-1" href="{{ route('services.edit',$service->id) }}" name="Editar">Editar</a>
